...
CREATE TABLE `juice_task` (
  ...
  `agent_host` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `log_path` varchar(1024) COLLATE utf8mb4_unicode_ci DEFAULT '',
  `retry` int(1) DEFAULT '0',
  `task_info_json` text COLLATE utf8mb4_unicode_ci,
